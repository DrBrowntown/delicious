...
function typeAhead(search) {
  ...
  searchInput.on("input", function () {
    ...
    _axios2.default.get("/api/search?q=" + this.value).then(function (res) {
      ...
      // nothing came back
      searchResults.innerHTML = _dompurify2.default.sanitize("<div=\".search__result\">No results for this " + _this.value + " found!</div>");
    }).catch(function (err) {
      console.error(err);
    });
  });
...
var _map = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \".modules/map\""); e.code = 'MODULE_NOT_FOUND';; throw e; }()));
